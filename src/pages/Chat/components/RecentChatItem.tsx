...
const RecentChatItem = (props: RecentChatItemsProps) => (
	<RowBetween style={{ margin: "0 0 18px 0" }}>
		<Row>
			...
			<Col>
				<BrokenText m="auto auto 4px 8px">
					{props.title}
				</BrokenText>

				<BrokenText fontSize="8pt" m="auto auto 4px 8px" color={COLORS.GREY.SHADE}>
					{props.subtitle}
				</BrokenText>
			</Col>
		</Row>
...
const BrokenText = styled.span<{m?: string, color?: string, fontSize?: string}>`
